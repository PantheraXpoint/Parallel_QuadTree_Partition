...
for layer in layerList:
    ...
    for feature in layer.getFeatures():
        extent = QgsRectangle(feature.attributes()[2],feature.attributes()[3],feature.attributes()[4],feature.attributes()[5])
        file_name = 'Q:\\test\\' + layer.name() + '_' +str(feature.attributes()[0]) + '.tif'
        print(file_name)
